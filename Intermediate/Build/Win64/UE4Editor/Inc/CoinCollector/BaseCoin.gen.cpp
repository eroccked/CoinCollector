...
// End Cross Module References
	...
	{
		P_GET_OBJECT(AActor,Z_Param_OverlappedActorm);
		P_GET_OBJECT(AActor,Z_Param_OtherActor);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->OnOverlap_Implementation(Z_Param_OverlappedActorm,Z_Param_OtherActor);
		P_NATIVE_END;
	}
	...
	void ABaseCoin::OnOverlap(AActor* OverlappedActorm, AActor* OtherActor)
	{
		BaseCoin_eventOnOverlap_Parms Parms;
		Parms.OverlappedActorm=OverlappedActorm;
	...
	{
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_OverlappedActorm;
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ABaseCoin_OnOverlap_Statics::NewProp_OverlappedActorm = { "OverlappedActorm", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(BaseCoin_eventOnOverlap_Parms, OverlappedActorm), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ABaseCoin_OnOverlap_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ABaseCoin_OnOverlap_Statics::NewProp_OverlappedActorm,
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ABaseCoin_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ABaseCoin_OnOverlap, "OnOverlap" }, // 2430156731
	...
	IMPLEMENT_CLASS(ABaseCoin, 2042977199);
